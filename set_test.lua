...
check("{2 4 6 8}" == even:tostring(), even, 1)
check(#even == 4, 4, 2)
odd = SetX:new(1, 3, 5, 7, 9)
check("{1 3 5 7 9}" == odd:tostring(), odd, 3)
check(#odd == 5, 5, 4)
even:add(10)
check("{10 2 4 6 8}" == even:tostring(), even, 5)
check(#even == 5, 5, 6)
odd:add(11, 13)
check("{1 11 13 3 5 7 9}" == odd:tostring(), odd, 7)
check(#odd == 7, 7, 8)
...
e2 = even:copy()
check("{10 2 4 6 8}" == e2:tostring(), #e2, e2, e2:tostring(), 13)
check(#e2 == 5, 5)
